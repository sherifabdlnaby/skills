...
**Watch a PR's CI and reviews** -> [`references/watch.md`](references/watch.md) Babysit a PR and watch it until it's green, and react to review comments as they come in.
Uses `scripts/pr-watch.py` which watch and notify you on PR updates instead of sleep loops that waste time.
