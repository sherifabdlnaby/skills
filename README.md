...
<p>
  ...
  <img src="https://img.shields.io/badge/All%20Markdown-94%2C057%20tokens-2ea44f?style=flat-square" alt="All Markdown: 94,057 tokens" />
</p>
...
| [`domain-modeling`](skills/vendor/domain-modeling/)                             |      766 |  1,917 |
| [`gh-stack`](skills/vendor/gh-stack/)                                           |    2,070 |  6,873 |
| [`handoff`](skills/vendor/handoff/)                                             |      182 |    182 |
| [`humanizer`](skills/vendor/humanizer/)                                         |    6,633 |  7,174 |
| [`improve-codebase-architecture`](skills/vendor/improve-codebase-architecture/) |    1,342 |  2,938 |
| [`prototype`](skills/vendor/prototype/)                                         |      642 |  3,546 |
| [`show-me`](skills/vendor/show-me/)                                             |      775 |    775 |
| [`teach`](skills/vendor/teach/)                                                 |    1,946 |  3,804 |
| [`wait-what`](skills/vendor/wait-what/)                                         |      100 |    100 |
| [`writing-for-agents`](skills/vendor/writing-for-agents/)                       |    2,349 |  2,916 |
...
| `domain-modeling`               | [`ADR-FORMAT.md`](skills/vendor/domain-modeling/ADR-FORMAT.md)                                            |    618 |
| `domain-modeling`               | [`CONTEXT-FORMAT.md`](skills/vendor/domain-modeling/CONTEXT-FORMAT.md)                                    |    533 |
| `domain-modeling`               | [`SKILL.md`](skills/vendor/domain-modeling/SKILL.md)                                                      |    766 |
| `gh-stack`                      | [`SKILL.md`](skills/vendor/gh-stack/SKILL.md)                                                             |  2,070 |
| `gh-stack`                      | [`references/commands.md`](skills/vendor/gh-stack/references/commands.md)                                 |  2,242 |
| `gh-stack`                      | [`references/stack-design.md`](skills/vendor/gh-stack/references/stack-design.md)                         |    946 |
| `gh-stack`                      | [`references/troubleshooting.md`](skills/vendor/gh-stack/references/troubleshooting.md)                   |  1,615 |
| `handoff`                       | [`SKILL.md`](skills/vendor/handoff/SKILL.md)                                                              |    182 |
| `humanizer`                     | [`AGENTS.md`](skills/vendor/humanizer/AGENTS.md)                                                          |    541 |
| `humanizer`                     | [`SKILL.md`](skills/vendor/humanizer/SKILL.md)                                                            |  6,633 |
| `improve-codebase-architecture` | [`HTML-REPORT.md`](skills/vendor/improve-codebase-architecture/HTML-REPORT.md)                            |  1,596 |
| `improve-codebase-architecture` | [`SKILL.md`](skills/vendor/improve-codebase-architecture/SKILL.md)                                        |  1,342 |
| `prototype`                     | [`LOGIC.md`](skills/vendor/prototype/LOGIC.md)                                                            |  1,329 |
| `prototype`                     | [`SKILL.md`](skills/vendor/prototype/SKILL.md)                                                            |    642 |
| `prototype`                     | [`UI.md`](skills/vendor/prototype/UI.md)                                                                  |  1,575 |
| `show-me`                       | [`SKILL.md`](skills/vendor/show-me/SKILL.md)                                                              |    775 |
| `teach`                         | [`GLOSSARY-FORMAT.md`](skills/vendor/teach/GLOSSARY-FORMAT.md)                                            |    484 |
| `teach`                         | [`LEARNING-RECORD-FORMAT.md`](skills/vendor/teach/LEARNING-RECORD-FORMAT.md)                              |    588 |
| `teach`                         | [`MISSION-FORMAT.md`](skills/vendor/teach/MISSION-FORMAT.md)                                              |    349 |
| `teach`                         | [`RESOURCES-FORMAT.md`](skills/vendor/teach/RESOURCES-FORMAT.md)                                          |    437 |
| `teach`                         | [`SKILL.md`](skills/vendor/teach/SKILL.md)                                                                |  1,946 |
| `wait-what`                     | [`SKILL.md`](skills/vendor/wait-what/SKILL.md)                                                            |    100 |
| `writing-for-agents`            | [`SKILL-MECHANICS.md`](skills/vendor/writing-for-agents/SKILL-MECHANICS.md)                               |    567 |
| `writing-for-agents`            | [`SKILL.md`](skills/vendor/writing-for-agents/SKILL.md)                                                   |  2,349 |
