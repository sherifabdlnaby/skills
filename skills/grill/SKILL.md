---
name: grill
description: A relentless interview that asks every frontier question at once, round by round. (Sherif's version).
...
the questions you can ask *now* without guessing at answers you haven't heard yet. Ask the whole
...
whose answer depends on another question still open in this round belongs to a *later* round, not
this one.
...
Use the Harness Ask User Tool to ask user questions. Highlighting recommended questions.
Batch questions using the tool.
