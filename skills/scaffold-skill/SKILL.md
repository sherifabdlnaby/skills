...
- **Focus on Triggering**: Only target on what makes an Agent/User know to use the skill, don't enumerate what the skill does inside in the description, only what get someone who merely knows some
  keywords get to trigger the skill.
