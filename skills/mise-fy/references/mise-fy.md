...
5. **No Global Config Workarounds**: Your goal is to make a project portable, working around problems by modifying user global settings is not a good strategy.
...
Per area, follow the matching reference, converse with user when required.
...
The mise-fy isn't done until every box is accounted for:
