...
When a picture is worth attaching at all is [`pull-requests.md`](./pull-requests.md#attaching-media).
The PR body's **Screenshots** slot is where it lands; placement of that slot is
[`pull-requests.md`](./pull-requests.md#body-and-description).
...
In a PR body that place is the **Screenshots** block.
